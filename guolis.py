...
inputSkip = wx.TextCtrl(frame,-1,pos=(180, 120), size=(50, 20), value=('50'))
inputRange = wx.TextCtrl(frame,-1,pos=(180, 150), size=(50, 20), value=('10'))
isSkipPoint = wx.RadioButton(frame,label = 'apsisukimai',pos=(240, 120))
isSkipTime = wx.RadioButton(frame,label = 'sekundes',pos=(340, 120), style=wx.RB_GROUP)
isSkipPoint.SetValue(1)
isInputPoint = wx.RadioButton(frame,label = 'apsisukimai',pos=(240, 150))
isInputTime = wx.RadioButton(frame,label = 'sekundes',pos=(340, 150), style=wx.RB_GROUP)
